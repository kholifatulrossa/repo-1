      ...
      <Box
        ...
        <List
          ...
          <div>
            ...
            <ListItemWithIcon IconComponent={DraftsIcon} text="Permohonan izin" href="/admin/perizinan" selected={selected === 'kategori'} onClick={() => handleClick('kategori')} />
            <ListItemWithIcon IconComponent={ClassRoundedIcon} text="Data Kelas" href="/admin/dataKelas" selected={selected === 'kategori'} onClick={() => handleClick('kategori')} />
          </div>
        </List>
      </Box>
